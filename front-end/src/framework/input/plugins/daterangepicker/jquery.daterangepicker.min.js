        ...
        (Z.fn.dateRangePicker = function (p) {
            ...
            function f(e) {
                ...
                return (
                    "week-range" === p.batchMode
                        ? (t = "monday" === p.startOfWeek ? Q(parseInt(e)).startOf("isoweek").valueOf() : Q(parseInt(e)).startOf("week").valueOf())
                        : "month-range" === p.batchMode && (t = Q(parseInt(e)).startOf("month").valueOf()),
                    t
                );
            }
            function v(e) {
                ...
                return (
                    "week-range" === p.batchMode
                        ? (t = "monday" === p.startOfWeek ? Q(parseInt(e)).endOf("isoweek").valueOf() : Q(parseInt(e)).endOf("week").valueOf())
                        : "month-range" === p.batchMode && (t = Q(parseInt(e)).endOf("month").valueOf()),
                    t
                );
            }
            function g(e) {
                    ...
                    if (
                        ...
                        p.singleDate
                            ...
                            ? "monday" === p.startOfWeek
                                ? ((p.start = Q(parseInt(t)).startOf("isoweek").valueOf()), (p.end = Q(parseInt(t)).endOf("isoweek").valueOf()))
                                : ((p.end = Q(parseInt(t)).endOf("week").valueOf()), (p.start = Q(parseInt(t)).startOf("week").valueOf()))
                            : "workweek" === p.batchMode
                            ? ((p.start = Q(parseInt(t)).day(1).valueOf()), (p.end = Q(parseInt(t)).day(5).valueOf()))
                            : "weekend" === p.batchMode
                            ? ((p.start = Q(parseInt(t)).day(6).valueOf()), (p.end = Q(parseInt(t)).day(7).valueOf()))
                            : "month" === p.batchMode
                            ? ((p.start = Q(parseInt(t)).startOf("month").valueOf()), (p.end = Q(parseInt(t)).endOf("month").valueOf()))
            ...
            function D(e) {
                ...
                s && o.isSameOrBefore(s) && (o = s.add("month2" === n ? 1 : 0, "month")),
                    ...
                    z(o, n),
                    "month1" === n
                        ? (p.stickyMonths || Q(o).isSameOrAfter(p[r], "month")) && z(Q(o).add(1, "month"), r)
                        : (p.stickyMonths || Q(o).isSameOrBefore(p[r], "month")) && z(Q(o).add(-1, "month"), r),
                    I();
            }
            function x() {
            ...
            function M() {
                ...
                p.singleDate
                    ...
                    ? ((p.start = !1),
                      ...
                      m.find(".drp_top-bar").removeClass("normal").addClass("error").find(".error-top").html(K("less-than").replace("%d", p.maxDays)))
                    : p.minDays && e < p.minDays
                    ? ((p.start = !1),
                      (p.end = !1),
                      m.find(".day").removeClass("checked"),
                      m.find(".drp_top-bar").removeClass("normal").addClass("error").find(".error-top").html(K("more-than").replace("%d", p.minDays)))
                    : p.start || p.end
                    ? m.find(".drp_top-bar").removeClass("error").addClass("normal")
                    : m.find(".drp_top-bar").removeClass("error").removeClass("normal"),
                    ...
                    p.batchMode &&
                        ((p.start && p.startDate && F(p.start, p.startDate) < 0) || (p.end && p.endDate && 0 < F(p.end, p.endDate))) &&
                        ((p.start = !1), (p.end = !1), m.find(".day").removeClass("checked"));
            }
            function S(e, t) {
                var a;
                    ...
                    (m.find(".day").each(function () {
                        ...
                        p.time.enabled &&
                            ...
                            (a = Q(a || Q().valueOf())
                                .startOf("day")
                                .valueOf())),
                            (p.start && p.end && e <= a && t <= e) || (p.start && !p.end && Q(t).format("YYYY-MM-DD") == Q(e).format("YYYY-MM-DD"))
            ...
            function z(e, t) {
                var a = (function (e, t) {
                        ...
                        return P(
                            "month",
                            V({ minSelectable: i, maxSelectable: o, minVisible: d, maxVisible: l }, a, function (e) {
                                return A(e);
                            })
                        );
                    })((e = Q(e).toDate()), t),
            ...
            function I() {
                ...
                var e = parseInt(Q(p.month1).format("YYYYMM")),
                    ...
                    a = Math.abs(e - t);
                1 < a && 89 != a
                    ? m.addClass("has-gap").removeClass("no-gap").find(".gap").css("visibility", "visible")
                    : m.removeClass("has-gap").addClass("no-gap").find(".gap").css("visibility", "hidden");
            ...
            function _() {
                ...
                return (
                    p.lookBehind
                        ...
                        : (p.startDate && L(e, p.startDate) < 0 && (e = Q(p.startDate).toDate()), p.endDate && 0 < L(H(e), p.endDate) && (e = R(Q(p.endDate).toDate()))),
                    p.singleDate && (p.startDate && L(e, p.startDate) < 0 && (e = Q(p.startDate).toDate()), p.endDate && 0 < L(e, p.endDate) && (e = Q(p.endDate).toDate())),
                    e
                );
            }
            function G(e) {
